...
class StructureSimilarityDialog : public ChemData::AbstractClusteringWidget
{
  Q_OBJECT
...
public:
  ...
  void setMolecules(const std::vector<ChemData::MoleculeRef> &molecules);
...
private:
  ...
  std::vector<ChemData::MoleculeRef> m_molecules;
};
