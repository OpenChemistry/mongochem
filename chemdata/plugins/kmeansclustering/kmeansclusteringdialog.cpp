...
public:
  ...
  int kValue;
  std::vector<ChemData::MoleculeRef> molecules;
...
KMeansClusteringDialog::KMeansClusteringDialog(QWidget *parent_)
  : ChemData::AbstractClusteringWidget(parent_),
...
void KMeansClusteringDialog::setMolecules(const std::vector<ChemData::MoleculeRef> &molecules_)
{
  // call super-class
  ChemData::AbstractClusteringWidget::setMolecules(molecules_);
  ...
  foreach (const ChemData::MoleculeRef &ref, molecules_) {
